    ...
    <div ref={pageRef}>
      <div className="mb-6 fade-in">
        ...
        <p className="text-slate-400 text-sm mt-1">
          Update your professional profile and bank details for operational fund
          management
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
        ...
        <div className="fade-in bg-white rounded-xl border border-slate-200/80 p-4 md:p-5 shadow-sm">
          <h3 className="text-sm font-heading font-bold text-primary uppercase tracking-wider mb-4 flex items-center gap-2">
            ...
            <span className="text-[9px] font-bold text-rose-500 uppercase tracking-wider ml-auto tracking-tighter">
              Required for Staff Reimbursements
            </span>
          </h3>
          <div className="space-y-4">
            <div>
        ...
        <div className="mt-4 fade-in bg-amber-50 border border-amber-200 rounded-xl p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-amber-600 mt-0.5">
              Ensure your bank details are accurate to receive operational fund
              disbursements.
            </p>
          </div>
        </div>
