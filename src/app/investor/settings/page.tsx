  ...
  return (
    <div ref={pageRef}>
      <div className="mb-6 fade-in">
        <h1 className="text-xl md:text-2xl font-heading font-extrabold text-primary tracking-tight">Account Settings</h1>
        <p className="text-slate-400 text-sm mt-1">Update your profile and bank details for withdrawals</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
        ...
        <div className="fade-in bg-white rounded-xl border border-slate-200/80 p-4 md:p-5">
          <h3 className="text-sm font-heading font-bold text-primary uppercase tracking-wider mb-4 flex items-center gap-2">
            ...
            Bank Details
            <span className="text-[9px] font-bold text-rose-500 uppercase tracking-wider ml-auto">Required for Withdrawals</span>
          </h3>
          <div className="space-y-4">
            <div>
      ...
      {(!profile.bank_name || !profile.account_number || !profile.account_name) && (
        <div className="mt-4 fade-in bg-amber-50 border border-amber-200 rounded-xl p-4 flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-bold text-amber-800">Bank details required</p>
            <p className="text-xs text-amber-600 mt-0.5">You need to add your bank details before you can request a withdrawal.</p>
          </div>
        </div>
      )}
    </div>
