...
export default function AboutPage() {
  ...
  useEffect(() => {
    if (loading || !settings || !pageRef.current) return;
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(
        pageRef.current!.querySelectorAll(
          ".stat-card, .value-card, .team-card, .career-card",
        ),
        { y: 30, opacity: 0 },
        {
          y: 0,
      ...
      <div className="pt-40 pb-16 text-center max-w-4xl mx-auto px-6">
        <div className="hero-text">
          ...
          <p className="text-slate-500 text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
            FlockFund was born from a simple observation: poultry farming is
            profitable, but the barrier to entry is high. Land, infrastructure,
            expertise, and capital — most people don't have all four. We bridge
            the gap, allowing anyone to co-own broiler chickens, earn profits,
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-20">
            <div>
              ...
              <p className="text-white/60 text-base mt-4 leading-relaxed">
                To make poultry farming accessible, transparent, and profitable
                for everyone. No farm required. No expertise needed. Just a
            ...
            <div>
              ...
              <p className="text-white/60 text-base mt-4 leading-relaxed">
                We blend the tangible nature of farming with the speed,
                verification, and transparency of financial technology. You
                track every stage from day-old chick to payout.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-500 text-sm mt-4 max-w-xl mx-auto">
              We are a dedicated group of agricultural experts, technologists,
              and business leaders committed to making farm co-ownership a
              seamless reality.
            </p>
          </div>
            ...
            {team.map((t) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-accent font-bold text-[10px] uppercase tracking-widest mt-0.5 mb-2">
                    {t.role}
                  </p>
          ...
          <div className="grid lg:grid-cols-12 gap-12">
            <div className="lg:col-span-5">
              ...
              <p className="text-slate-500 text-base leading-relaxed mb-6">
                We're building something different — where technology meets
                agriculture, and transparency is non-negotiable. Your work here
                helps people invest in real, tangible assets to build reliable
                wealth.
              </p>
              <ul className="space-y-4 text-slate-600 text-sm">
                <li className="flex items-center gap-3">
                  ...
                  <strong>Mission-Driven:</strong> Real impact on food security
                ...
                <li className="flex items-center gap-3">
                  ...
                  <strong>Growth Environment:</strong> We invest heavily in your
                ...
                <li className="flex items-center gap-3">
                  ...
                  <strong>Flexible Culture:</strong> Remote-first roles and
                  dynamic farm settings.
                </li>
              </ul>
              ...
              <div className="mt-8 p-5 bg-slate-50 rounded-2xl border border-slate-100">
                <p className="text-xs text-slate-500">
                  ...
                  Openings are actively being filled internally or via selective
                  referral at this time. When public slots open, we will list
                  application links explicitly here. We remain an equal
            ...
            <div className="lg:col-span-7">
              <h3 className="font-bold text-primary text-xl mb-6">
                Recognized Roles
              </h3>
              <div className="space-y-4">
                {careers.map((job) => (
                  <div
                    key={job.title}
                    className="career-card border border-slate-200 rounded-2xl p-6 bg-white hover:border-accent/30 transition-colors"
                  >
      ...
      >
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center">
          ...
          <p className="text-white/60 text-base leading-relaxed mb-12 max-w-2xl mx-auto">
            Whether you are an aspiring investor having trouble setting up your
            wallet, or a large scale buyer looking to secure off-take of our
            premium broilers, our team is directly accessible.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white/[0.03] backdrop-blur-md rounded-2xl p-8 border border-white/[0.06]">
              ...
              <p className="text-white/40 text-sm mb-4">
                General inquiries, wallet issues, and cycle clarifications.
              </p>
              <a
                href="mailto:flockfund001@gmail.com"
                className="text-accent font-bold hover:underline"
              >
                flockfund001@gmail.com
              </a>
            </div>
            ...
            <div className="bg-white/[0.03] backdrop-blur-md rounded-2xl p-8 border border-white/[0.06]">
              ...
              <p className="text-white/40 text-sm mb-4">
                Platform bugs, security reporting, and API integrations.
              </p>
              <a
                href="mailto:tech.plexus001@gmail.com"
                className="text-accent font-bold hover:underline"
              >
                tech.plexus001@gmail.com
              </a>
            </div>
          </div>
        </div>
