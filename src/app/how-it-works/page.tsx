...
const steps = [
  {
    ...
    description:
      "Sign up with your email and select your role — Investor, Farm Manager, or Keeper. Each role gets a purpose-built dashboard designed for their specific workflows. The onboarding process includes identity verification for secure investment.",
    details: [
  ...
  },
  {
    ...
    description:
      "Once your investment is active, our professional keepers manage daily care — feeding, weighing, health checks, and medication. Farm Managers (licensed veterinarians) review and approve every report. You watch it all unfold in real time from your dashboard.",
    details: [
  ...
  },
  {
    ...
    description:
      "At approximately Day 28, birds reach market weight and are sold through our diversified sales channels. The Admin confirms the sale price, quantity, and buyer details. Revenue is automatically calculated and recorded on the ledger.",
    details: [
...
const safeguards = [
  {
    ...
    desc: "Every farm report, transaction, and metrics update is digitally recorded and visible from your dashboard in real time.",
    icon: "visibility",
  },
  {
    title: "Blockchain Proof",
    desc: "Investment and payout hashes are stored on-chain, providing an immutable audit trail for every financial transaction.",
    icon: "link",
  },
  {
    title: "Veterinary Oversight",
    desc: "Licensed farm managers review every health report. Veterinary protocols are followed for medication, vaccination, and disease control.",
    icon: "medical_services",
  },
  {
    title: "Smart Pricing",
    desc: "Cost-per-bird is dynamically calculated from real DOC, feed, and medicine costs. Once invested, only the sale price affects your returns.",
    icon: "calculate",
  },
  {
    title: "Gamification",
    desc: "Earn badges for milestones, climb leaderboards, refer friends for bonuses, and engage with the investor community forum.",
    icon: "military_tech",
  },
  {
    title: "Data-Driven Intelligence",
    desc: "FCR analytics, weight curves, mortality patterns, and growth projections give you deep insight into flock performance.",
    icon: "analytics",
  },
];
...
export default function HowItWorks() {
  ...
  const dynamicSteps = [
    ...
    {
      ...steps[4],
      description: `After the sale, under the Islamic Finance model, your capital is returned first. Verified costs are deducted, and the remaining net profit is split ${100 - investorShare}/${investorShare} — ${100 - investorShare}% to FlockFund, ${investorShare}% to investors. Your share is credited to your wallet, where you can reinvest for compounding growth or withdraw to your bank account.`,
      details: [
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(
        pageRef.current!.querySelectorAll(".role-card"),
        { y: 30, opacity: 0 },
        {
          y: 0,
          opacity: 1,
      ...
      gsap.fromTo(
        pageRef.current!.querySelectorAll(".safeguard-card"),
        { y: 30, opacity: 0 },
        {
          y: 0,
          opacity: 1,
      ...
      <div className="pt-32 pb-16 text-center max-w-4xl mx-auto px-6">
        <div className="hero-text">
          ...
          <h1 className="font-heading text-4xl md:text-6xl font-extrabold text-primary mt-4 tracking-tighter leading-[1.1]">
            From Sign-Up to <span className="text-accent">Profit</span> in 5
            Steps
          </h1>
          <p className="text-slate-400 text-base md:text-lg mt-5 max-w-2xl mx-auto leading-relaxed">
            FlockFund digitises the entire poultry investment lifecycle — from
            funding Day-Old Chicks to receiving your profit share in just{" "}
            {cycleDuration} days. Zero offline interaction, complete digital
            transparency, automated returns.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 pb-20">
        <div className="space-y-5">
          {dynamicSteps.map((step) => (
            <div
              key={step.num}
              className="step-card bg-white rounded-2xl border border-slate-200/80 shadow-sm hover:shadow-xl transition-all duration-300 group overflow-hidden"
            >
              <div className="flex items-start gap-5 p-6 md:p-8">
                <div
                  className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${step.gradient} flex items-center justify-center flex-shrink-0 shadow-lg group-hover:scale-110 transition-transform duration-300`}
                >
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    {step.details.map((d) => (
                      ...
                      >
                        <span className="material-symbols-outlined text-accent text-sm mt-0.5 flex-shrink-0">
                          check_circle
                        </span>
                        {d}
                      </p>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-white/40 text-sm mt-3 max-w-xl mx-auto">
              Every role has a dedicated dashboard and workflow. Together, they
              form an integrated digital farm management system.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-5">
            {roles.map((r) => (
              <div
                key={r.role}
                className="role-card bg-white/[0.04] rounded-2xl p-6 border border-white/[0.06] hover:bg-white/[0.08] transition-all duration-300 group"
              >
                <div className="flex items-center gap-3 mb-4">
                  <div
                    className={`w-11 h-11 rounded-xl ${r.color}/20 flex items-center justify-center`}
                  >
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-400 text-sm mt-2 max-w-xl mx-auto">
              Every feature is designed to give you confidence in your
              investment and clarity on your returns.
            </p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {safeguards.map((s) => (
              <div
                key={s.title}
                className="safeguard-card bg-white rounded-xl border border-slate-200/80 p-5 hover:shadow-md transition-all duration-300 group"
              >
      ...
      <div className="bg-slate-50 py-16 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <h2 className="font-heading text-2xl font-extrabold text-primary mt-3 tracking-tight">
              Track Your Investment Through Every Stage
            </h2>
          </div>
          <div className="flex flex-wrap justify-center gap-3">
            {[
              ...
              <div key={s.status} className="flex items-center gap-2">
                <div
                  className={`flex items-center gap-2 px-4 py-2.5 rounded-xl ${s.color} text-xs font-bold`}
                >
                ...
                {i < 6 && (
                  <span className="material-symbols-outlined text-slate-300 text-sm hidden md:block">
                    arrow_forward
                  </span>
                )}
              </div>
