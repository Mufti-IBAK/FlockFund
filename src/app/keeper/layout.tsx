        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-2 flex items-center justify-between">
          <div className="flex items-center gap-4 md:gap-6">
            ...
            <button
              ...
              className="lg:hidden w-8 h-8 rounded-md bg-slate-50 flex items-center justify-center border border-slate-100"
            >
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-heading font-extrabold text-primary text-sm tracking-tight">
                FlockFund
              </span>
            </div>
            {/* Desktop nav */}
            <nav className="hidden lg:flex gap-0.5">
              {navItems.map((item) => {
                ...
                return (
                  ...
                  >
                    <span
                      className={`material-symbols-outlined text-base ${isActive ? "text-primary" : "text-slate-300"}`}
                      style={{ fontSize: '18px' }}
                    >
                      {item.icon}
                    </span>
